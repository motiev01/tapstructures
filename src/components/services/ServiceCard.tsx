...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, onClick }) => {
  ...
  const thumbnailSrc = importImage(service.thumbnailUrl);

  // Log thumbnail loading attempt
  React.useEffect(() => {
    console.log(`ServiceCard: Loading thumbnail for ${service.title}`, {
      thumbnailUrl: service.thumbnailUrl,
      importedSrc: thumbnailSrc
    });
  }, [service.thumbnailUrl, thumbnailSrc, service.title]);
